...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Orion-Browser", self)
        about_action.setStatusTip("Find out more about Orion-browser")  # Hungry!
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Orion-Browser" % title)
...
app.setApplicationName("wild-Browser")
app.setOrganizationName("wild")
